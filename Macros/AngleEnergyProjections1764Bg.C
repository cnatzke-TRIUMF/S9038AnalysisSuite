...
void AngleEnergyProjections1764Bg(){
...
TFile f2(BgRunName);
 ...
 hBg->SetTitle("48hrs Background Run: 1764keV");
...
//  h1X->GetYaxis()->SetRangeUser(0, YMax);
 h1X->SetTitle("48hrs background, 1764keV");
...
// padc->SetLogy();
  ...
  hGam->GetXaxis()->SetRange(1300, 2800);
  // hGam->GetYaxis()->SetRangeUser(0, YMax);
 hGam->SetTitle("48hrs background, 1764keV");
...
// h1Y->Rebin(3.); // Now 120keV per bin
 h1Y->SetTitle("48hrs background, 1764keV");
