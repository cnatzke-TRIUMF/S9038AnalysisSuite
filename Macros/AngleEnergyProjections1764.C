...
void AngleEnergyProjections1764(){
 ...
 TString Sr1HistoName("AB_AngDiff_Supp_1764");
...
TFile f2(BgRunName);
 ...
 hSr1->SetTitle("200hrs 90Sr Run: 1764keV");
...
//  h1X->GetYaxis()->SetRangeUser(0, YMax);
 h1X->SetTitle("200hrs 90Sr source, 1764keV");
...
// padc->SetLogy();
 ...
 hGam->SetTitle("200hrs 90Sr source, 1764keV");
...
// h1Y->Rebin(3.); // Now 120keV per bin
 h1Y->SetTitle("200hrs 90Sr source, 1764keV");
