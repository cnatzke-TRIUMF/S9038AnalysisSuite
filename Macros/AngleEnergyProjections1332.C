...
void AngleEnergyProjections1770(){
   ...
   TString CoRunName("/data4/S9038/Histograms/TwoPhotonGriffinAnglePlots15685_000-004.root");
   ...
   // Get the spectra from the 60Co histogram
   TFile f2(BiRunName);
   TH2* hBg = 0;
   TH1* hGam = 0;
   ...
   hBg->SetTitle("1hr 60Co Run: 1332keV");
   ...
   */
   ...
   hGam->SetTitle("1hr 60Co run, 1332keV");
