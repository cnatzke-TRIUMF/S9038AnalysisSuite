...
Float_t gateEnergy = 1770.; //keV
Float_t electronRestMassEnergy = 511.; //keV
Float_t E_kin = gateEnergy - electronRestMassEnergy; //keV
...
void AngleEnergyProjections1770(){
   ...
   TString BiRunName("/data4/S9038/Histograms/TwoPhotonGriffinAnglePlots15685_000-004.root");
   ...
   TString BiHistoName("AB_AngDiff_Supp_1770");
   ...
   // Get the spectra from the 207Bi histogram
   TFile f2(BiRunName);
   TH2* hBg = 0;
   TH1* hGam = 0;
   f2.GetObject(BiHistoName,hBg); // Native binning is 10 degrees and 2keV per bin.
   ...
   hBg->SetTitle("1hr 207Bi Run: 1770keV");
   ...
   */
   ...
   h1X->SetTitle("1hr 207Bi, 1770keV");
   ...
   hGam->GetXaxis()->SetRange(1000, 2500);
   // hGam->GetYaxis()->SetRangeUser(0, YMax);
   hGam->SetTitle("1hr 207Bi run, 1770keV");
   ...
   h1Y->SetTitle("1hr 207Bi, 1770keV");
