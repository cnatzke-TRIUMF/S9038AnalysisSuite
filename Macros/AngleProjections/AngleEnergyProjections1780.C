...
void AngleEnergyProjections1780(){
 ...
 TString Sr1HistoName("AB_AngDiff_Supp_1780");
...
TFile f2(BgRunName);
 ...
 hSr1->SetTitle("200hrs 90Sr Run: 1780keV BG");
...
//  h1X->GetYaxis()->SetRangeUser(0, YMax);
 h1X->SetTitle("200hrs 90Sr source, 1780keV BG");
...
// padc->SetLogy();
 ...
 hGam->SetTitle("200hrs 90Sr source, 1780keV BG");
...
// h1Y->Rebin(3.); // Now 120keV per bin
 h1Y->SetTitle("200hrs 90Sr source, 1780keV BG");
